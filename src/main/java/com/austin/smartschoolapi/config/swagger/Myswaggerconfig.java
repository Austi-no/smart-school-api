package com.austin.smartschoolapi.config.swagger;
...
public class Myswaggerconfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Smart School API").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("Austin").version("1.0.1").build();
    }
